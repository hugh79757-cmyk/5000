"""layover_writer.py - Layover Tours And Stopover Guides guide generator"""
...
def generate_layover_guide(topic):
    ...
    h2s = """  ## Making the Most of a Layover in {city}
  ## Best Layover Tours in {city}
  ## What You Can See in 4-8 Hours
  ## Prices and Logistics
  ## Layover Tips for {city} Airport"""
    prompt = f"""Write a layover tours and stopover guides guide for {city}, {country}.
...
- Title must include "{city}" and relate to layover tours and stopover guides
...
- Write as a frequent flyer and layover specialist who maximizes every stopover
