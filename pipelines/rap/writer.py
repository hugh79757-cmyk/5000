...
5. 같은 내용을 반복하지 마세요
6. "특히" 표현 사용 금지
7. 반드시 2,500자 이상 작성하세요. 2,200자 미만은 불합격입니다. 각 H2 섹션마다 최소 3~5문장을 작성하세요"""
...
- 월세 환산: 전세보증금 기준 연 4~5% 수익률로 월세 환산 예시
- 전세 안전 체크리스트: 등기부등본 확인, 전세보증보험(HUG/SGI), 확정일자, 전입신고
...
- 청약 당첨 확률 높이는 팁 포함
- 반드시 2,500자 이상 작성하세요. 2,200자 미만은 불합격입니다. 각 H2 섹션마다 최소 3~5문장을 작성하세요
- 마지막: 핵심 요약 3줄
- 면책 문구를 본문에 넣지 마세요 (시스템이 자동 삽입합니다)
