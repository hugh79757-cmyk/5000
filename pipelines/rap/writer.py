...
■ 청약 신청 절차 안내 (서술형으로 자유롭게 작성):
  청약홈(applyhome.co.kr) 또는 모바일 앱에서 본인인증 후, 청약통장 순위 및 예치금을 확인하고 원하는 주택형을 선택해 신청합니다. 당첨자 발표 확인 후 서류 제출과 계약 절차를 진행합니다.
...
- 현재 월 포함 권장
- 제공된 키워드 반영
- **지역(시/군/구) + 시점(YYYY년 M월) + 가격(억/만원/보증금) 중 2개 이상 필수 포함**
