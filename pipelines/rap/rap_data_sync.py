...
SYNC_REGIONS = [
    ...
    # 광역시 추가
    ("27290", "대구", "달서구"), ("27140", "대구", "동구"),
    ("28200", "인천", "남동구"),
    ("30140", "대전", "동구"), ("30200", "대전", "유성구"),
    ("29200", "광주", "광산구"), ("26410", "부산", "수영구"),
    # 경기 추가
    ("41220", "경기", "평택시"), ("41113", "경기", "수원시권선구"),
    ("41173", "경기", "안양시동안구"), ("41590", "경기", "화성시"),
    # 지방 주요
    ("43130", "충북", "충주시"), ("43750", "충북", "진천군"),
    ("44200", "충남", "아산시"), ("46150", "전남", "순천시"),
    ("47190", "경북", "구미시"), ("47111", "경북", "포항시남구"),
    ("48310", "경남", "거제시"), ("36110", "세종", "세종시"),
]
