...
CATEGORY_COLORS = {
    "의료지원":     [(40, 15, 55), (70, 35, 85)],   # Muted plum
    "돌봄서비스":   [(10, 50, 45), (20, 85, 70)],   # Muted teal
    "교통복지":     [(50, 45, 20), (85, 75, 40)],   # Warm olive
    "생활지원":     [(35, 20, 60), (60, 40, 95)],   # Purple-violet
    "연금생활지원": [(65, 20, 30), (110, 40, 55)],  # Deep burgundy
    "일자리금융":   [(20, 35, 60), (40, 65, 100)],  # Deep blue
    "문화여가":     [(60, 20, 55), (95, 40, 85)],   # Rose-purple
    "default":      [(30, 15, 42), (50, 30, 65)],   # Deep plum base
}

BADGE_COLORS = {
    "의료지원":     (91, 44, 111),    # #5B2C6F
    "돌봄서비스":   (13, 107, 94),    # #0D6B5E
    "교통복지":     (107, 93, 46),    # #6B5D2E
    "생활지원":     (76, 45, 122),    # #4C2D7A
    "연금생활지원": (139, 46, 62),    # #8B2E3E
    "일자리금융":   (45, 76, 122),    # #2D4C7A
    "문화여가":     (122, 45, 107),   # #7A2D6B
    "default":      (59, 30, 84),     # #3B1E54
}
