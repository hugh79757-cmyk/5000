...
def generate_content(data, blog_id="travel-hugo"):
    ...
    TITLE_TEMPLATES = {
        ...
        "travel2-hugo": [
            "{region} {theme} {count}곳 입장료·운영시간 총정리",
            "{region} 문화유산 {count}선 역사 탐방 코스",
            "{region} 국보·보물 {count}곳 현장 방문 후기",
            "{region} 사적지 {count}곳 해설 프로그램 안내",
            "{region} 역사 여행 {count}곳 주차·교통 정보",
            "{region} 문화재 탐방 {count}곳 사진 포인트 공개",
        ],
        "travel3-hugo": [
