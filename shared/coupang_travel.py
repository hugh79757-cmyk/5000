...
TRAVEL_KEYWORD_MAP = {
    ...
    "rap-hugo": [
        "삼성 비스포크 냉장고", "LG 건조기", "삼성 식기세척기",
        "LG 공기청정기", "삼성 에어컨", "LG 로봇청소기",
        "다이슨 무선청소기", "코웨이 정수기", "LG 스타일러",
        "삼성 인덕션", "LG 워시타워", "코웨이 비데",
        "삼성 스마트도어락", "시몬스 매트리스", "LG 디오스 냉장고",
        "삼성 무풍에어컨", "LG 코드제로", "쿠쿠 밥솥",
        "일룸 매트리스", "음식물처리기",
    ],
    "rap2-hugo": [
    ...
    "rap5-hugo": [
        "삼성 비스포크 냉장고", "LG 시그니처 세탁기", "삼성 식기세척기",
        "드롱기 커피머신", "LG 퓨리케어 공기청정기", "다이슨 에어랩",
        "삼성 비스포크 에어컨", "LG 스타일러", "일룸 매트리스",
        "삼성 인덕션", "코웨이 아이콘 정수기", "LG 코드제로",
        "보쉬 식기세척기", "시몬스 매트리스", "위닉스 제습기",
        "발뮤다 토스터", "네스프레소 커피머신", "다이슨 무선청소기",
        "LG 디오스 와인셀러", "코웨이 비데",
    ],
}
