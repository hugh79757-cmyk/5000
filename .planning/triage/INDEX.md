- 2026-09-23 | fix | infra-pause-checker-fix | car.db checker timeout+retry+sandbox 폴백, pick-hugo 재활성화 (INFRA-PAUSE-20260920)
- 2026-09-23 | fix | r12-layout-cleanup-recovery | 37개 사이트 R12 layouts 정리: 46 junk 삭제 + 12 legit Git 복구 + Hugo 빌드 검증 + pending_fixes 49건 모두 resolved
- 2026-09-23 | fix | cap-hugo-r08-rejected | cap-hugo R08 stale canary: site_path 없음 → rejected (44 canary 기존 resolved 유지)
- 2026-09-12 | fix | publish-error-batch-12 | 12건 8그룹: guide P04 W5 수정(차단포스트 bmw_m4 이미지 삽입+로컬커밋 692b954, 최근3일 R13 0건) / rap4·rap no_trade_data 외부대기 / airlines 토픽 1137 전량소진(리필 별도) / appliance 에스프레소 정상키워드 / ipo transient / 대시보드밖 3건: rap2 CRITICAL 실측정확+게이트무차단(설계구멍) + baby·appliance P14 임계값미달(3연속시 자동등록) -> 20260912--publish-error-batch-12.md
